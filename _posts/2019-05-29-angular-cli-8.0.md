...
This tool generates the code necessary to compile your application with Ivy enabled (by generating the `ɵcmp` field, `ɵmod` field, etc. for each dependency you use).
